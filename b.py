...
train_df = ndf.iloc[:121455, :].copy()
actual_x = ndf.iloc[121455:, :].copy()
...
PER_ASSET_CSV = OUT_DIR / "per_asset_metrics_gbm.csv"
...
print("\nPer-(asset,gap) eval (top rows for key assets):")
